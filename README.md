...
- **Level jumps.** A volume, gain, fader or route reaches your monitors and headphones the moment you change it. In Gazelle, clicking a bar jumps straight to that point, Ctrl+click puts a fader or volume at unity (a double-click goes to a safe -20 dB unless you choose unity), Home on a fader is 0 dB, and the mouse wheel moves whatever is under the pointer. Routing a source straight to an output bypasses every fader. *Gazelle* sends nothing until you act, disables every control the moment its connection drops and never replays a change later, and offers Mute everywhere and Hard mute on the Quadro. *You:* keep monitors and headphones low whenever you try something new, and know where your physical mute is.
