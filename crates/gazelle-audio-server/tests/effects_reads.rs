...
fn app() -> axum::Router {
    ...
    http::router(AppState { devices, store, snapshots: Arc::new(MemorySnapshotStore::default()), force_dry_run: false, backend: "loopback".into(), themes_dir: None, show_window: None })
}
