...
//!
//! The recovered command set lives in `refs/schemas/in_scope_commands.json` (63
...
pub const IN_SCOPE_COMMANDS_PATH: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/../../refs/schemas/in_scope_commands.json");
