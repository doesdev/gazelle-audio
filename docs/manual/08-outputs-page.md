...
|---|---|
| **Volume** | From 0 dB (the loudest) down to -inf (silent), in 1 dB steps; Page Up and Page Down move 6 dB. Double-click for -30 dB, Ctrl+click for 0 dB |
...
- **Level**: the talkback level. Double-click for -30 dB, Ctrl+click for 0 dB.
