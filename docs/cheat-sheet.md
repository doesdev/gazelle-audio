...
Control for the Antelope Zen Quadro Synergy Core and Zen Studio+. Independent software, not affiliated with Antelope Audio. Version 1.4.1, Windows. Tested on one person's two units: go carefully.
