...
Gazelle controls Antelope Audio's Zen Quadro Synergy Core and Zen Studio+ interfaces. This manual covers version 1.4.0 on Windows. Read [Safety](manual/02-safety.md) before anything else.
